...
public:
    ...
    Student(const String& name = "", const String& student_number = "", const String& question = "")
        : name(name), student_number(student_number), question(question) {}
};
...
public:
    ...
    Classroom(const String& current_name = "", const String& current_student_number = "", const String& current_question = "", bool away_from_desk = false)
        : current_name(current_name), current_student_number(current_student_number), current_question(current_question), away_from_desk(away_from_desk), queue_size(0) {}
